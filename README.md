...
def smoke_test_tflite(
    ...
    for i in range(5):
        ...
        print(
            f"真实类别: {class_names[labels[i]]} "
            f"-> 预测类别: {class_names[predicted_id]}"
        )
...
<img width="1280" height="764" alt="联想截图_20260603145457" src="https://github.com/user-attachments/assets/4303291b-b6c2-4880-b687-a5ab15a942ca" />
<img width="1080" height="2400" alt="Screenshot_20260603_145414" src="https://github.com/user-attachments/assets/2e07694d-752e-42b3-b4c6-4ba0e0a9b3e8" />
